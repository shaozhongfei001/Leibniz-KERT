...
name: 财务状况与经营能力分析
requiredFactLabel: F
dataSources: [enterpriseData.financialSummary, ASSET-KNOW-FINANCIAL-ANALYSIS]
---

# 任务：撰写章节 CH03 财务状况与经营能力分析

基于财务框架与财务摘要计算比率（毛利率/净利率/流动比/资产负债率/经营现金流），给出盈利能力、偿债能力、现金流结论。数据标签 F，推断标签 C。
