...
- 独立评审报告：`docs/dd/KERT_生产级混合架构独立评审报告_2026-08-26_V1.0.md`
- SHA-256：`2d1f7a1bfe7776df0b4c9dfd4bb2a7c14f30e0bae7c826dd5128e687d4228feb`

## 2. 工作区与源码锚点

- 项目根：`/home/szf/dev/deepseek_harness/data_knowledge_ws/kert`
...
已形成 `docs/architecture/KERT_CONTROLLED_HYBRID_ARCHITECTURE_V1.0_CANDIDATE.md` 和 ADR-016。
