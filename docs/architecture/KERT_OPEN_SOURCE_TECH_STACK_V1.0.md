# KERT 开源技术栈选型 V1.0（候选）

> 状态：CANDIDATE
> 日期：2026-08-26
> 优先级：企业级稳定性 > 技术栈成熟项目引用 > 高性能 > 国产化
> 关联：Phase 0 整改包、`KERT_PRODUCTION_EVOLUTION_PLAN_V2_CANDIDATE.md`
...
| 应用语言 | Python 3.11（CPython） | Python 3.12 | 与现有 KERT 工程一致，生态成熟 |
...
| 热更新生效 | `kert-admin skill activate <skillId> <version>` | 原子切换 CURRENT 指针；Worker 重启/重新加载 |
...
Skill 包 v1.0.0
  ...
  → 校验签名/哈希/schema
  → kert-admin skill activate <skillId> 1.0.0
