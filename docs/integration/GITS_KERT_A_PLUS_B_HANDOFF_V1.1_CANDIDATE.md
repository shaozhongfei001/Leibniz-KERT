...
- GITS 只通过 KERT Python Core 公共 HTTP/OpenAPI 调用
- GITS 不直连 Java Skill Runtime
- GITS 不感知 KERT 内部 Java Runtime 拓扑

## 顺序

1. B：移除 Mock/H2/fallback 伪成功，fail-closed 空态
2. A：恢复 GITS→KERT 公共 HTTP Adapter
